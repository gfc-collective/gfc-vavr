...
/**
 * ScalaFutureAdapter is implemented in Java because it
 * is impossible to implement in Scala. The Scala compiler
 * does not allow us to subclass io.vavr.concurrent.Future.
 * Vavr's Future implements a method called 'eq' and this
 * makes the Scala compiler very unhappy.
 */
public class ScalaFutureAdapter<T>
    implements io.vavr.concurrent.Future<T> {
